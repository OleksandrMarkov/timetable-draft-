...
namespace AppConsole
{
	...
	public class Dep_ComputerSoftware : ExcelFile
	{
		...
		public Dep_ComputerSoftware(string fileName, int firstRow, int lastRow): base(fileName)
		{
		...
		public override void Load()
		{
			if(reading)
			{
				try
				{
					...
					mySqlCommand.Parameters.AddWithValue("@DEPARTMENT", "ПЗ");
					...
					connection.Close();
					Console.WriteLine("ComputerSoftware Department is loaded!");
				}
				catch(Exception ex)
				{
