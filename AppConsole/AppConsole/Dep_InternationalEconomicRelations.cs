...
namespace AppConsole
{
	...
	public class Dep_InternationalEconomicRelations : ExcelFile
	{
		...
		public Dep_InternationalEconomicRelations(string fileName, int firstRow, int lastRow): base(fileName)
		{
		...
		public override void Load()
		{
			if(reading)
			{
				try
				{
					...
					mySqlCommand.Parameters.AddWithValue("@DEPARTMENT", "МЕВ");
					...
					connection.Close();
					Console.WriteLine("InternationalEconomicRelations Department is loaded!");
				}
				catch(Exception ex)
				{
